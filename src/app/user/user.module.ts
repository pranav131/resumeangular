...
@NgModule({
  declarations: [UserComponent,ObjectiveComponent, EducationComponent, ProfessionComponent, SkillsComponent, EducationListComponent, EducationAddComponent, EducationUpdateComponent, SkillListComponent, SkillAddComponent, SkillUpdateComponent, ProfessionListComponent, ProfessionAddComponent, ProfessionDeleteComponent, HobbiesComponent, ObjectiveComponent],
  imports: [
    CommonModule,
    UserRoutingModule,
  ...
  entryComponents: [ObjectiveComponent, EducationAddComponent , SkillAddComponent , EducationUpdateComponent],
})
